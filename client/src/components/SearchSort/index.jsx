    ...
    return (
        <form className={`lg:ml-7 lg:pl-7 lg:border-l lg:border-slate-400 flex lg:flex-col justify-between lg:justify-start mb-5 lg:mb-0 flex-wrap gap-3 lg:w-[250px] ${styles.heading6}`} onSubmit={onSearchSortSubmit}>
            ...
            <input
                ...
                className='border-2 lg:mt-4 border-slate-400 px-3 sm:px-5 lg:py-2 py-1 outline-none focus:border-slate-600 rounded-3xl flex-1 lg:flex-none'
            />
            ...
            <select
                ...
                className={`lg:mt-4 ${styles.heading6} font-bold px-3 py-2 rounded-3xl bg-slate-400 cursor-pointer`}
            >
